...
int JuneVHF::highlightBand(int b,ModeTypes modeType) const
{
    ...
    case (BAND6): return 0;
    case (BAND2): return 1;
    case (BAND222): return 2;
    case (BAND420): return 3;
    case (BAND902): return 4;
    case (BAND1240): return 5;
    default: return 5;
    }
}
...
{
    switch (col) {
    case 0: return multsWorked[ii][CWType][BAND6];
    case 1: return multsWorked[ii][CWType][BAND2];
    case 2: return multsWorked[ii][CWType][BAND222];
    case 3: return multsWorked[ii][CWType][BAND420];
    case 4: return multsWorked[ii][CWType][BAND902];
    case 5: return multsWorked[ii][CWType][BAND1240];
    default:
        return 0;
    }
}
...
bool JuneVHF::validateExchange(Qso *qso)
{
    ...
    case (BAND902):
        ...
        qso->isamult[0]=true;
        break;
    case (BAND1240): case (BAND2200):case (BAND3300): case (BAND5650):
    case (BAND10000): case (BAND24000):case (BAND47000):case (BAND76000):
    case (BAND122000):case (BAND134000):case (BAND241000):
        qso->bandColumn=5;
        qso->isamult[0]=true;
        break;
...
void JuneVHF::addQso(Qso *qso)
{
    ...
    case (BAND902):case (BAND1240):
        ...
        qso->isamult[0] = true;
        break;
    case (BAND2300): case (BAND3300):case (BAND5650):case (BAND10000):case (BAND24000):
    case (BAND47000): case (BAND76000): case (BAND122000):case (BAND134000):case (BAND241000):
        qso->pts=4;
        qso->isamult[0] = true;
        break;
    default:
